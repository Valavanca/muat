...
def preprocessing_fromdmm(args):
    """Preprocessing from dmm files to csv files for each mutation type and count file for each mutation type and sample name
    """
...
if __name__ == '__main__':
    ...
    test = preprocessing_fromvcf('./data/raw/vcf/00b9d0e6-69dc-4345-bffd-ce32880c8eef.consensus.20160830.somatic.snv_mnv.vcf')
