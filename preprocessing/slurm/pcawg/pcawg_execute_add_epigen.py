...
pd_allsamples = pd.read_csv('/users/primasan/projects/muat/extfile/all_tumoursamples_pcawg.tsv',sep='\t', index_col=0) 
...
for i in range(len(pd_allsamples)):
    ...
    check_data = pd.read_csv('/scratch/project_2001668/data/pcawg/allclasses/tokenized/' + pcawg_histology + '/SNV_' + samp,index_col=0)
